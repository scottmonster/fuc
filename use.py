...
2. Override with CLI arguments:
   python use.py --app_name "Custom App" --server.debug true --server.ports 3000 3001
...
4. Set via environment variables:
   ...
   export FUC_MYAPP_LOG_LEVEL=DEBUG
   export FUC_MYAPP_DATABASE_HOST=postgres.example.com
   export FUC_MYAPP_DATABASE_PORT=5433
   export FUC_MYAPP_SERVER_DEBUG=true
   python use.py
...
6. Environment variables (FUC_MYAPP_*)
